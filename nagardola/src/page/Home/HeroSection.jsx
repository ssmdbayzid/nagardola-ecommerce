...
export default function HeroSection() {
    return (
        <div className='flex '>
            <ul className="w-1/4 flex flex-col gap-3 ps-10 text-center">
                {categories.map((category, index) =>
                    <li key={index}><a href={category.link} className='font-semibold'>{category.display}</a></li>)}
            </ul>
            <div className="w-3/4 relative  hero_banner bg-[url('https://themes.pixelstrap.net/katie/assets/images/layout-3/1.jpg')] bg-cover ">
                ...
                <p className='absolute top-20 -right-5 uppercase -rotate-90 flex items-center gap-2'>Follow us 
